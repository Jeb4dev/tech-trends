...
export const languages = [
  ...
  ["Golang", "Go-lang", "Golangiin", "Go ohjelmistokehittäjä", "!go live", "!go to", "!go-to", "!go ahead", "!go with", "!go for"],
  "Rust",
  "Scala",
  "Kotlin",
  ["Swift", "!swiftly"],
...
export const databases = [
  ["Relational databases", "SQL", "MySQL", "PostgreSQL", "SQLite", "MariaDB", "MS-SQL", "Microsoft SQL Server", "Oracle Database"],
  ["NoSQL databases", "NoSQL", "no-SQL", "MongoDB", "DynamoDB", "Redis", "Cassandra", "Neo4j", "Couchbase", "CouchDB", "Elasticsearch", "OpenSearch", "ArangoDB"],
  ["Vector databases", "vectorDB", "vector database", "vector-database", "vektori tietokannat", "vektori tietokanta", "Pinecone", "Weaviate", "Milvus", "Qdrant", "Chroma"],
  "Snowflake",
...
export const positions = [
  ...
  ["Cyber Security", "Security Engineering", "Security Engineer", "Tietoturva", "Tietoturvakonsultti", "tietoturvan", "Security Analyst", "SOC Analyst"],
